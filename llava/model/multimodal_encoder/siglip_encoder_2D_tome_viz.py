...
class SigLipVisionTower2Dtomeviz(nn.Module):
    ...
    def forward(self, images, output_source=False):
        if type(images) is list:
            ...
            image_forward_outs, source = self.vision_tower(images.to(device=self.device, dtype=self.dtype), output_hidden_states=True)
