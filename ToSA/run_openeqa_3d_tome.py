...
class llava_chatbot:
    ...
    def update_images(self, images_list, image_masks=None):
        ...
        self.depth_tensors = torch.stack([self.process_depth(img_path.replace('rgb', 'depth_pred')) for img_path in images_list]).to(dtype=torch.float16, device=device)
...
if __name__ == "__main__":
    ...
    output_path = f'../openeqa/2025_tome/3d_tome_{ckpt_name}_{alpha_style}_{token_merging_ratio_str}.json'
